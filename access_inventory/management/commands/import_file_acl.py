...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        with transaction.atomic():
            servers_by_name = self.import_file_servers(data, stats['file_servers'])
            shares_by_unc = self.import_shares(data, servers_by_name, stats['shares'])
            folders_by_key = self.import_folders(data, shares_by_unc, stats['folders'])
            self.import_acl_entries(data, folders_by_key, stats['acl_entries'])
    ...
    def import_file_servers(self, data, stats):
        servers_by_name = {}
    ...
    def import_shares(self, data, servers_by_name, stats):
        shares_by_unc = {}
    ...
    def import_folders(self, data, shares_by_unc, stats):
        folders_by_key = {}
    ...
    def import_acl_entries(self, data, folders_by_key, stats):

...
class AgentMachine(models.Model):
    ...
    updater_version = models.CharField(max_length=50, blank=True)
    tray_version = models.CharField(max_length=50, blank=True)
    ...
    maintenance_window_timezone = models.CharField(max_length=64, blank=True)

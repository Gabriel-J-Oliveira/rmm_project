...
urlpatterns = [
    ...
    path('users/', views.ticket_users, name='users'),
    path('users/<int:pk>/', views.ticket_user_detail, name='user-detail'),
    ...
    path('api/ad-users/', views.ticket_api_ad_users, name='api-ad-users'),
    ...
    path('<int:number>/api/requester-link/', views.ticket_api_requester_link, name='api-requester-link'),

...
urlpatterns = [
    ...
    path('api/agent/rollout-campaigns/<uuid:pk>/', fleet_views.rollout_detail, name='api-rollout-detail'),
    path('api/agent/rollout-campaigns/<uuid:pk>/actions/', fleet_views.rollout_control, name='api-rollout-actions'),
    path('api/agent/rollout-campaigns/<uuid:pk>/waves/<uuid:wave_id>/actions/', fleet_views.rollout_control, name='api-rollout-wave-actions'),
    path('agent-rollouts/', fleet_views.rollout_operations, name='agent-rollouts'),
    ...
    path('api/endpoints/<str:pk>/uninstall/', dashboard_views.endpoint_uninstall_request, name='api-endpoint-uninstall'),
    path('api/endpoints/<str:pk>/uninstall/<uuid:request_id>/cancel/', dashboard_views.endpoint_uninstall_cancel, name='api-endpoint-uninstall-cancel'),
